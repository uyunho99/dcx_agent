      ...
      <div className="flex flex-1 min-h-0">
        <div className="flex-1 flex flex-col min-w-0 relative">
          ...
          {!chatOpen && (
            <button
              ...
              className="absolute top-16 right-4 w-10 h-10 rounded-full bg-teal-500 text-white shadow-lg hover:bg-teal-600 active:scale-95 transition-all flex items-center justify-center text-lg"
              title="챗봇 열기"
            >
              💬
            </button>
        ...
        {chatOpen && (
          <div className="w-[400px] shrink-0 bg-white/60 backdrop-blur-xl flex flex-col shadow-[-4px_0_20px_rgba(0,0,0,0.06)] border-l border-white/30">
            <div className="px-5 py-3.5 border-b border-teal-400/30 bg-teal-500/90 backdrop-blur-sm font-semibold text-sm text-white flex items-center justify-between">
              <span>인사이트 챗봇</span>
